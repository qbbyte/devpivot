<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="文档模板(SIMPLE精简/STANDARD标准/DETAIL详细)" prop="templateType">
        <el-select v-model="queryParams.templateType" placeholder="请选择文档模板(SIMPLE精简/STANDARD标准/DETAIL详细)" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="docList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="文档模板(SIMPLE精简/STANDARD标准/DETAIL详细)" align="center" prop="templateType">
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="docRef" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="文档模板(SIMPLE精简/STANDARD标准/DETAIL详细)" prop="templateType">
              <el-select v-model="form.templateType" placeholder="请选择文档模板(SIMPLE精简/STANDARD标准/DETAIL详细)">
                <el-option
                  v-for="dict in ai_prd_template"
                  :key="dict.value"
                  :label="dict.label"
